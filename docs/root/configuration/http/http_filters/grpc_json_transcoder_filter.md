...
-   This filter should be configured with the name
    *envoy.filters.http.grpc\_json\_transcoder*.
...
set [match\_incoming\_request\_route]{.title-ref} to true.
...
[content\_type](https://github.com/googleapis/googleapis/blob/master/google/api/httpbody.proto#L68)
...
[content-type]{.title-ref} from the first [google.api.HttpBody
\<https://github.com/googleapis/googleapis/blob/master/google/api/httpbody.proto\>]{.title-ref}.
